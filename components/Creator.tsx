...
const Creator: React.FC = () => {
    return (
        <section className="py-20 bg-white relative overflow-hidden border-t border-gray-100">
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-brand-yellow/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full md:w-1/2 lg:w-5/12">
                        <div className="relative group mx-auto max-w-sm md:max-w-none">
                            <div className="absolute inset-0 bg-brand-blue rounded-[2rem] rotate-3 group-hover:rotate-6 transition-transform duration-300 opacity-20"></div>
                            <img 
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border border-gray-100 flex items-center gap-3 animate-bounce-slow">
                                <div className="bg-brand-blue/10 p-2 rounded-full">
                                    <Star className="text-brand-blue" size={24} fill="currentColor" />
                                </div>
                                <div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-7/12 text-left">
                        <span className="inline-block px-4 py-1 bg-brand-blue/10 text-brand-blue font-bold rounded-full text-sm mb-4">
                            QUEM IDEALIZOU O PROJETO?
                        </span>
                        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                            Prazer, eu sou a Maria! <span className="text-brand-yellow">👋</span>
                        </h2>
                        ...
                        <div className="mt-8 pt-8 border-t border-brand-blue/10 flex items-center gap-4">
                            <div className="flex-1">
                                <p className="font-handwriting text-4xl text-brand-blue transform -rotate-2">
                                    Maria Clara
                                </p>
                            </div>
                        </div>
